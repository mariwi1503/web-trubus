  ...
  return (
    <DialogPrimitive.Root open={open} onOpenChange={setOpen}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className="fixed left-[50%] top-[50%] z-[100] max-h-[calc(100vh-2rem)] max-w-[calc(100vw-2rem)] translate-x-[-50%] translate-y-[-50%] focus:outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]">
          ...
          <div className="relative max-h-[65vh] max-w-[65vw] overflow-hidden rounded-3xl">
            {/* Custom Close Button */}
            ...
            <div 
              ...
              className="cursor-pointer overflow-hidden rounded-3xl transition-transform hover:scale-[1.02] active:scale-[0.98]"
            >
              <img 
                src="/images/promo-durian.png" 
                alt="Promo Bibit Durian Raja" 
                className="block h-auto max-h-[65vh] w-auto max-w-[65vw] object-contain drop-shadow-2xl"
              />
            </div>
          </div>
